...
Open-source ERP and CRM for businesses
...
- **dolibarr**: tuxgasy/dolibarr:latest

### Infrastructure Components

- **dolibarr-db**: Mariadb database
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/dolibarr/main/docker-compose.yaml" -o compose.yml
```
...
- **Web Interface**: http://172.17.0.1:8071
